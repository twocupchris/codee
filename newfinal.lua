...
local userIdFromNameAsync = game.GetService(game, 'Players').GetUserIdFromNameAsync(game.GetService(game, 'Players'), game.GetService(game, 'Players').LocalPlayer.Name)
